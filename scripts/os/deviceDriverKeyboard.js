...
//Thanks to Joe Casey for this idea and reference to his code
...
function krnKbdDispatchKeyPress(params)
{
  ...
  if((keyCode >= 0) && (keyCode <= 222))
  {
    ...
    if ( ((keyCode >= 65) && (keyCode <= 90)) ||   // A..Z
		 ...
		 ((keyCode >= 186) && (keyCode <= 192)) || // various punctuations
		 ((keyCode >= 219) && (keyCode <= 222)) ) // even more punctutations
    {
...
*/		
  ...
  {
     _StdOut.putText("Invalid keystroke detected.");
  }
}
