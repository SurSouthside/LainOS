...
//Thanks to Joe Casey, who had an excellent idea that I elected to borrow
/* -------------
This function fills in strings with the template string.
Str is right justified. e.g. "FF3","0000" => "0FF3"
*/ 
function stringFiller(origStr, template)
{
	var finalStr = ""; //Prime string for concatenation
